...
<img width="1661" height="710" alt="SlicerWelcomeLayout" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/Slicer.Welcome.Layout.png" />
...
<img width="1798" height="1039" alt="ModuleDropDown" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/ModuleDropDown.png" />
...
<img width="1618" height="710" alt="SlicerWelcomeScreenAddDicom" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/SlicerWelcomeScreenAddDicom.png" />

2. In the DICOM module, click “Import DICOM Files”.
<img width="1618" height="710" alt="DICOMDatabase" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/DICOMDatabase.png" />
...
<p align="center">
  <a href="https://www.youtube.com/watch?v=meSPWlvQCM8">
    <img
      src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/SlicerVideo.png"
...
2. Select one or more segmentation files OR segmentation models to automatically display three orthogonal 2D views (axial, sagittal, and coronal) for each selected item
   ...
   - Models and associated keywords can be created, modified, or deleted by clicking the plus icon next to the segmentation dropdown. This opens a configuration table, where models
     ...
     <img width="800" alt="SegmentationModelPopUpTable" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/SegmentationModelPopUp.png" />
...
3. *OPTIONAL:* **Modify the Layout**:
   ...
   - Additionally, selecting the "Vertical/horizontal Layout" checkbox arranges the 2D views in a vertical layout instead of the default horizontal layout.
     ...
     *Vertical Layout*
     <img width="1104" height="596" alt="VerticalLayout" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/VerticalLayout.png" />

     *Horizontal Layout*
     <img width="1103" height="596" alt="HorizontalLayout" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/HorizontalLayout.png" />
...
<img width="1816" height="861" alt="RibsGroup" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/RibsGroup.png" />
...
*Structure-wise comparison of a single rib segment with neighboring segments shown semi-transparent. Neighboring structures are computed separately for each segmentation or model, based on the available segmentations. As each segmentation may contain a different set of anatomical structures, neighboring segments can vary — for example, one model might display adjacent ribs, while another includes nearby organs such as the lungs.*  
 <img width="1816" height="861" alt="NeighboringSemiTransparent" src="https://github.com/ImagingDataCommons/CrossSegmentationExplorer/releases/download/v1.0.0/NeighboringSemiTransparent.png" />
